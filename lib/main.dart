...
void main() {
  runApp(const MyApp());
  const config =
      AppMetricaConfig("daa46e63-d4a6-46d1-bbf9-0dcf4b482b83", logs: true);
  ...
  AppMetrica.reportEventWithMap("eventWithEmptyMapIsNull", null);
  AppMetrica.reportEventWithJson("eventWithJSONParamsIsNull", null);
